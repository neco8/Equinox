...
(def selectors
  {:duration-input [{:tag "input" :aria-label "session-duration-input"}]
   ...
   :inhale [{:tag "button" :aria-label "inhale"}]
   :inhale-hold [{:tag "button" :aria-label "inhale-hold"}]
   :exhale [{:tag "button" :aria-label "exhale"}]
   :exhale-hold [{:tag "button" :aria-label "exhale-hold"}]
